...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add New Studies</h2>
            </div>
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('Studies.index') }}" title="Go back"> <i class="fas fa-backward "></i> </a>
            </div>
        </div>
    </div>
    ...
    @endif
    <form action="{{ route('Studies.store') }}" method="POST" class="w-full max-w-lg">
        @csrf
